// scripts/import-to-production.js
const fs = require('fs');
const path = require('path');
const mongoose = require('mongoose');

// MongoDB connection string - HARDCODED FOR RAILWAY PRODUCTION
...
async function importProducts() {
 try {
   ...
   console.log(`Successfully imported products to MongoDB Atlas (Production)!`);
 } catch (error) {
