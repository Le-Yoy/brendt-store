    ...
    <div className={styles.sizeSelector}>
      <div className={styles.header}>
        <span className={styles.label}>
          Size: <span className={styles.selected}>
      ...
      <div className={styles.options}>
        {sizes.map((size, index) => (
          <button
            ...
            } ${!size.available ? styles.optionUnavailable : ''}`}
      ...
      {!selectedSize && (
        <p className={styles.message}>Please select a size</p>
      )}

      {sizeGuideOpen && (
        <div className={styles.sizeGuide}>
          <div className={styles.overlay} onClick={toggleSizeGuide}></div>
          <div className={styles.content}>
            <button className={styles.close} onClick={toggleSizeGuide} aria-label="Close size guide">
              ×
            </button>
